...
def function_decrement(var_name) -> None:
  decremented_var = int(Variable_dict[var_name][0]) - 1
  Variable_dict[var_name] = (str(decremented_var), "Integer")
